...
.L071 ;  if joy0fire  &&  d = 0  &&  p = 1 then c = 1  :  ballx = x  :  bally = y - 5  :  sounda  =  5
...
.skip38then
.skipL071
.L072 ;  if joy0fire  &&  d = 1  &&  p = 1 then c = 2  :  ballx = x + 9  :  bally = y - 5  :  sounda  =  5
...
.L073 ;  if sounda  >  0 then sounda  =  sounda  -  1  :  AUDC0  =  4  :  AUDV0  =  4  :  AUDF0  =  sounda else AUDV0  =  0
...
.L074 ;  if c = 1 then ballx  =  ballx - 1
...
.condpart45
	DEC ballx
.skipL074
.L075 ;  if c = 2 then ballx  =  ballx + 1
...
.L078 ;  if c = 0 then ballx = 0  :  bally = 0
...
.L081 ;  if ballx > player3x - 7  &&  ballx < player3x + 1  &&  bally > player3y - 7  &&  bally < player3y + 1 then i = 0  :  score = score + 10  :  soundb  =  50
...
.L085 ;  if ballx > player2x - 7  &&  ballx < player2x + 1  &&  bally > player2y - 7  &&  bally < player2y + 1 then j = 0  :  score = score + 10  :  soundb  =  50
